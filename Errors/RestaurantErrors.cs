...
namespace FoodFlow.Errors
{
    public static class RestaurantErrors
    {
        ...
        public static readonly Error NoRestaurantsFound = new("Restaurant.NoRestaurantsFound", "No restaurants were found.", StatusCodes.Status404NotFound);
        public static readonly Error AlreadyExists = new("Restaurant.AlreadyExists", "A restaurant with the same name already exists.", StatusCodes.Status409Conflict);
    }
}