...
namespace FoodFlow.Persistence.Migrations
{
    ...
    [Migration("20250815113040_AddIsDisabledColumnToUsersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodFlow.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("FoodFlow.Entities.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodFlow.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodFlow.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodFlow.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("FoodFlow.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("FoodFlow.Entities.Category", b =>
                {
                    b.HasOne("FoodFlow.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
                    ...
                    b.HasOne("FoodFlow.Entities.ApplicationUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodFlow.Entities.MenuItem", b =>
                {
                    b.HasOne("FoodFlow.Entities.Category", "Category")
                        .WithMany("MenuItems")
            ...
            modelBuilder.Entity("FoodFlow.Entities.Order", b =>
                {
                    ...
                    b.HasOne("FoodFlow.Entities.ApplicationUser", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FoodFlow.Entities.OrderItem", b =>
                {
                    b.HasOne("FoodFlow.Entities.MenuItem", "MenuItem")
                        .WithMany("OrderItems")
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FoodFlow.Entities.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("FoodFlow.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FoodFlow.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
